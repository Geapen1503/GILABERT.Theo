...
// début code arrow project jarod
        ...
        btnDropJarod.addEventListener('click', () => {

          if (toggleIndex === 0) {
            dropdownjarod.style.backgroundColor = "grey";
            dropdownjarod.style.height = dropdownjarod.scrollHeight + "px";
            toggleIndex++;
          } else {
            dropdownjarod.style.backgroundColor = "transparent";
            dropdownjarod.style.height = btnDropJarod.scrollHeight + "px";
            toggleIndex--;
          }
        ...
        document.addEventListener('click', (event) => {
          if (!dropdownjarod.contains(event.target)) {
            dropdownjarod.style.backgroundColor = "transparent";
            dropdownjarod.style.height = btnDropJarod.scrollHeight + "px";
            toggleIndex = 0;
          }
